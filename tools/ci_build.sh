...
"$sdkmanager_bin" 'platform-tools' 'build-tools;34.0.0' 'platforms;android-34'
...
"$ANDROID_HOME/build-tools/34.0.0/aapt" dump badging build/bolt-yard-0.1.0.apk > build/package-info.log
sha256sum build/bolt-yard-0.1.0.apk > build/SHA256SUMS.txt
